...
namespace WindowsFormsApplication1
{
    class Majestic12ToXml
    {
        ...
        private static XElement FindParentOfNewNode(Majestic12.HTMLchunk m12chunk, string originalHtml, XElement nextPotentialParent)
        {
        ...
        private static XElement ParseTagNode(Majestic12.HTMLchunk m12chunk, string originalHtml, ref int xmlnsIndex)
        {
